...
public class CalculatorClient {
    ...
    private void playService() {
        try {
            ...
            System.out.println("Soma:" + this.CalculatorRI.add(2, 3));
            //System.out.println("Soma Array:" + this.CalculatorRI.add());
            System.out.println("Div:" + this.CalculatorRI.div(4, 2));
            System.out.println("Sub:" + this.CalculatorRI.sub(3, 2));
            System.out.println("Mul:" + this.CalculatorRI.mul(2, 3));
